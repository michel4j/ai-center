...
from aicenter.tracker import AdvancedConstrainedTracker
...
class TrackingApp:
    ...
    def __init__(self, model, uri):
        ...
        self.tracker = AdvancedConstrainedTracker()
        self.gonio = PV('MD1608-301:PMTR:omega:deg:fbk')
        self.uri = uri
    ...
    def run(self, scale=0.75):
        ...
        while self.running:
            ...
            results = self.model.predict(frame, persist=True, conf=0.01)
